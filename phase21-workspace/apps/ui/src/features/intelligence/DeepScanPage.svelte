...
<style>
  ...
  :global(.limitation-card){padding:15px 17px;border-radius:14px;margin:12px 0}:global(.limitation-card p){margin:.25rem 0;color:var(--ac-text-2)}:global(.limitation-card ul){margin:.5rem 0 0;padding-inline-start:1.25rem;color:var(--ac-text-3)}
  ...
  .result-heading{margin:18px 0 8px;font-size:var(--ac-type-body);text-transform:uppercase;letter-spacing:.08em;color:var(--ac-text-3)}.finding-list{display:grid;gap:9px}.history-panel summary{cursor:pointer;color:var(--ac-text-2);font-weight:600}
  :global(.healthy-result){text-align:center;padding:28px;border-radius:17px;margin-top:8px}:global(.healthy-result>div){font-size:var(--ac-type-title)}:global(.healthy-result h3){margin:.4rem 0 .2rem}:global(.healthy-result p){margin:0;color:var(--ac-text-2)}
