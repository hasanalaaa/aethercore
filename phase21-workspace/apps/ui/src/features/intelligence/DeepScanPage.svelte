...
<style>
  ...
  :global(.healthy-result){text-align:center;padding:28px;border-radius:17px;margin-top:8px}:global(.healthy-result>div){font-size:1.65rem}:global(.healthy-result h3){margin:.4rem 0 .2rem}:global(.healthy-result p){margin:0;color:var(--ac-text-2)}
