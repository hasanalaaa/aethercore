...
<style>
  ...
  .finding-copy h3{margin:.2rem 0 .25rem;font-size:var(--ac-type-headline);font-weight:590}.finding-copy p{margin:0;color:var(--ac-text-2);line-height:1.55}.finding-meta{display:flex;gap:10px;color:var(--ac-text-3);font-size:var(--ac-type-technical)}.safety-badge{align-self:start;border:1px solid var(--ac-border-subtle);border-radius:999px;padding:.3rem .55rem;font-size:var(--ac-type-body);color:var(--ac-text-2)}
  .verification-note{margin:12px 0 0;padding:9px 11px;border-radius:10px;border:1px solid var(--ac-border-subtle);background:var(--ac-material-base);color:var(--ac-text-2);font-size:var(--ac-type-body);line-height:1.45}
