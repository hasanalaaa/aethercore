...
/// The cancellation token fired before the budget could be granted.
...
fn sleep_cancellable(token: &CancellationToken, duration: Duration) -> Result<(), Cancelled> {
