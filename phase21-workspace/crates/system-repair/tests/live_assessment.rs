...
fn live_windows_repair_assessment_is_read_only_and_completes() {
    ...
    coordinator.start_assessment_with_lease(OWNER, lease).expect("start assessment");
    ...
    loop {
        ...
        match assessment.state {
            ...
            RepairAssessmentState::Failed => panic!("assessment failed: {}", assessment.error_message),
            _ => {}
        }
