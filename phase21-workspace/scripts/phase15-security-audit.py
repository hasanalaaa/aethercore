...
router=read('services/maintenance-service/src/router.rs'); composition=read('services/maintenance-service/src/composition.rs'); service_cargo=read('services/maintenance-service/Cargo.toml'); protocol=read('services/maintenance-service/src/protocol.rs'); errors=read('services/maintenance-service/src/errors.rs')
